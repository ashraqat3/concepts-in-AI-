...
# Get the default screen width and height   
screen_width = pyautogui.size()[0]
screen_height = pyautogui.size()[1]

# Set the width and height of the camera window
cam_width = 640
cam_height = 480

# Calculate the position for the camera window
...
def display_camera():
    while True:
        ...
        cv2.moveWindow("Gesture", cam_x, cam_y)
